...
- **Consider policy changes or exceptions.** For a small pilot, ask IT and security whether a documented exception is appropriate and what controls it requires. A team or department rollout may call for a broader policy review. Define the exception's scope, owner, and review date before approving it.
...
This table summarizes vendor documentation checked between **13 and 15 September 2026** for a standard x86-64 Omarchy desktop. It is not a record of agent installation tests. Recheck the linked requirements for the version you plan to deploy.
...
| [SentinelOne](https://www.sentinelone.com/platform/singularity-core/)<br>Not listed                                                                        | The product page lists supported Linux distributions without Arch or Omarchy. Confirm support for your distribution and agent version; a forced installation is not evidence of working protection.                                                                                                                                                                                                          |
| [Field Effect](https://support.fieldeffect.com/en/support/solutions/articles/16000148027-endpoint-agent-operating-system-requirements)<br>Not listed       | The endpoint agent's supported operating systems do not include Arch or Omarchy. Confirm the required protection and response capabilities with Field Effect before deployment.                                                                                                                                                                                                                              |
| [ConnectWise RMM](https://docs.connectwise.com/ConnectWise_RMM/Agents/Agent_Requirements)<br>Confirm scope                                                 | The agent requirements require vendor sign-in; obtain confirmation for Omarchy. Separately, ScreenConnect documents a [Wayland blank-screen limitation in its Java client](https://docs.connectwise.com/ScreenConnect_Documentation/Technical_support_bulletins/Blank_screens_on_Linux_machines_with_Wayland_enabled). Verify remote viewing and control on Hyprland for the client version you plan to use. |
